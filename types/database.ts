...
export interface Database {
  public: {
    Tables: {
      ...
      simulations: {
        Row: { id: number; fixture_id: number; result_json: Json; narrative: string | null; created_at: string }
        Insert: { fixture_id: number; result_json: Json; narrative?: string | null }
        Update: { fixture_id?: number; result_json?: Json; narrative?: string | null }
      }
      simulation_runs: {
